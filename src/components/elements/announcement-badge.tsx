  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        variant === 'normal' &&
          'bg-brand-600/10 text-brand-700 hover:bg-brand-600/15 dark:bg-white/5 dark:text-white dark:inset-ring-1 dark:inset-ring-white/5 dark:hover:bg-white/10',
        variant === 'overlay' &&
          'bg-brand-950/15 text-white hover:bg-brand-950/20 dark:bg-brand-950/20 dark:hover:bg-brand-950/25',
        className,
      )}
    >
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'bg-brand-600/20 dark:bg-white/10',
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'text-brand-700 dark:text-white',
        )}
      >
