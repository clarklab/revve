...
export function FeatureThreeColumnWithDemos({
  ...
  return (
    <div className={clsx('rounded-lg bg-brand-600/5 p-2 dark:bg-white/5', className)} {...props}>
      ...
      <div className="p-6 sm:p-10 lg:p-6">
        <h3 className="text-base/8 font-medium text-brand-950 dark:text-white">{headline}</h3>
        <div className="mt-2 flex flex-col gap-4 text-sm/7 text-brand-700 dark:text-brand-400">{subheadline}</div>
      </div>
    </div>
  )
}
