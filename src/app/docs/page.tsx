        ...
        <article id="docs-content" className="mx-auto max-w-3xl px-6 py-12 lg:px-10 lg:py-16">
          ...
          <section id="introduction" className="scroll-mt-24 pb-16">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h1 className="font-display text-4xl tracking-tight text-taupe-950 dark:text-white">
                  Revve Documentation
                </h1>
                <p className="mt-4 text-lg text-taupe-600 dark:text-taupe-400">
                  AI-powered customer service for financial institutions
                </p>
              </div>
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <p>
              ...
              <h2 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Key Capabilities</h2>
              <ul className="list-[square] pl-6 marker:text-taupe-400 dark:marker:text-taupe-600">
                <li className="pl-2">
                  <strong className="font-semibold text-taupe-950 dark:text-white">Voice Agents</strong> — Natural
                  conversations powered by our native voice models
                </li>
                <li className="pl-2">
                  <strong className="font-semibold text-taupe-950 dark:text-white">Chat Agents</strong> — Multi-channel
                  support across web, mobile, and messaging platforms
                </li>
                <li className="pl-2">
                  <strong className="font-semibold text-taupe-950 dark:text-white">Banking Integrations</strong> —
                  Secure connections to core banking systems
                </li>
                <li className="pl-2">
                  <strong className="font-semibold text-taupe-950 dark:text-white">Enterprise Security</strong> — SOC 2
          ...
          {/* Getting Started */}
          <section id="getting-started" className="scroll-mt-24 border-t border-taupe-200 py-16 dark:border-taupe-800">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-semibold text-taupe-950 dark:text-white">Getting Started</h2>
                <p className="mt-4 text-taupe-600 dark:text-taupe-400">
                  Get up and running with Revve in just a few steps.
                </p>
              </div>
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <h3 className="text-base/8 font-medium text-taupe-950 dark:text-white">1. Create Your Account</h3>
              <p>
                Sign up for a Revve account at{' '}
                <a href="#" className="font-semibold text-taupe-950 underline underline-offset-4 dark:text-white">
                  app.revve.ai
                </a>
                . You&apos;ll need to provide your organization details and verify your email address.
              </p>

              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">2. Generate API Keys</h3>
              <p>
              ...
              <div className="mt-4 overflow-x-auto rounded-lg bg-taupe-900 p-4 text-sm text-taupe-100 dark:bg-taupe-800">
                <pre>
...
curl https://api.revve.ai/v1/health \\
  -H "Authorization: Bearer $REVVE_API_KEY"`}</code>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">3. Configure Your Agent</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">4. Deploy to Production</h3>
              <p>
          ...
          {/* Voice Agents */}
          <section id="voice-agents" className="scroll-mt-24 border-t border-taupe-200 py-16 dark:border-taupe-800">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-semibold text-taupe-950 dark:text-white">Voice Agents</h2>
                <p className="mt-4 text-taupe-600 dark:text-taupe-400">
                  Natural voice conversations powered by our native voice models.
                </p>
              </div>
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <h3 className="text-base/8 font-medium text-taupe-950 dark:text-white">Native Voice Models</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Supported Languages</h3>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Voice Customization</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Call Routing & Handoff</h3>
              <p>
          ...
          {/* Chat Agents */}
          <section id="chat-agents" className="scroll-mt-24 border-t border-taupe-200 py-16 dark:border-taupe-800">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-semibold text-taupe-950 dark:text-white">Chat Agents</h2>
                <p className="mt-4 text-taupe-600 dark:text-taupe-400">
                  Multi-channel messaging support for web, mobile, and popular platforms.
                </p>
              </div>
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <h3 className="text-base/8 font-medium text-taupe-950 dark:text-white">Webchat Integration</h3>
              <p>
...
<script>
  Revve.init({
    ...
    position: 'bottom-right'
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Multi-Channel Support</h3>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Rich Message Types</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Conversation Context</h3>
              <p>
          ...
          <section
            ...
            className="scroll-mt-24 border-t border-taupe-200 py-16 dark:border-taupe-800"
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-semibold text-taupe-950 dark:text-white">
                  Banking Integrations
                </h2>
                <p className="mt-4 text-taupe-600 dark:text-taupe-400">
                  Secure connections to core banking systems and financial data.
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <h3 className="text-base/8 font-medium text-taupe-950 dark:text-white">Core Banking Connections</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">
                Account Lookup & Verification
              </h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Transaction Queries</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Secure Data Handling</h3>
              <p>
          ...
          {/* Knowledge Base */}
          <section id="knowledge-base" className="scroll-mt-24 border-t border-taupe-200 py-16 dark:border-taupe-800">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-semibold text-taupe-950 dark:text-white">Knowledge Base</h2>
                <p className="mt-4 text-taupe-600 dark:text-taupe-400">
                  Train your agent with your organization&apos;s specific knowledge.
                </p>
              </div>
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <h3 className="text-base/8 font-medium text-taupe-950 dark:text-white">Training Your Agent</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Document Ingestion</h3>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">FAQ Management</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Response Customization</h3>
              <p>
          ...
          {/* Analytics & Reporting */}
          <section id="analytics" className="scroll-mt-24 border-t border-taupe-200 py-16 dark:border-taupe-800">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-semibold text-taupe-950 dark:text-white">
                  Analytics & Reporting
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <h3 className="text-base/8 font-medium text-taupe-950 dark:text-white">Conversation Metrics</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Resolution Rates</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Customer Satisfaction</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Custom Dashboards</h3>
              <p>
          ...
          {/* Security & Compliance */}
          <section id="security" className="scroll-mt-24 border-t border-taupe-200 py-16 dark:border-taupe-800">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-semibold text-taupe-950 dark:text-white">
                  Security & Compliance
            ...
            <div className="mt-8 space-y-4 text-sm/7 text-taupe-700 dark:text-taupe-400">
              <h3 className="text-base/8 font-medium text-taupe-950 dark:text-white">SOC 2 Type II Certification</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Data Encryption</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">PCI DSS Compliance</h3>
              <p>
              ...
              <h3 className="mt-8 text-base/8 font-medium text-taupe-950 dark:text-white">Audit Logging</h3>
              <p>
              ...
              <div className="mt-8 rounded-lg border border-taupe-200 bg-taupe-50 p-4 dark:border-taupe-700 dark:bg-taupe-800">
                <p className="text-sm font-medium text-taupe-950 dark:text-white">Additional Compliance</p>
                <p className="mt-1 text-sm text-taupe-600 dark:text-taupe-400">
